      ...
      <div className=" max-w-7xl lg:container mx-auto bg-blue-500  mb-20 rounded-lg relative overflow-hidden [@media(max-width:500px)]:rounded-none ">
        <div className="relative bg-red-500">
          ...
          <img
            ...
            className="absolute right-[150] top-[-50] [@media(max-width:1000px)]:hidden"
        ...
        <div className="relative z-10 h-full flex flex-col justify-center pt-15  pb-15 px-8 md:px-20 ">
          ...
          <p
            ...
            data-aos-delay="200"
          >
            We&apos;ve partnered with 500+ leading organizations across 50+
            countries to deliver transformative consulting solutions and drive
